    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <SettingsDialog
            trigger={
              <button className="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 dark:bg-amber-700 dark:hover:bg-amber-600 text-white px-4 py-2 rounded-md transition-colors text-sm">
